...
export const SpriteModal: React.FunctionComponent<SpriteModalProps> = ({ setSelectSprite }) => {
  // const baseUrl = '../../images/sprites/';

  return (
    <div className='spriteModal'>
      <div className='sprite_wrapper'>
        {
          spriteList.map((sprite: SpriteProps): ReactElement => {
            return (
              <div className={`sprite_containers sprite_${sprite.id}`}
                key={`sprite_${sprite.id}`}
                onClick={() => setSelectSprite(sprite.id)}
